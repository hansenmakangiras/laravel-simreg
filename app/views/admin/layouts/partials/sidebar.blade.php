        <div class="span3">
            <div class="sidebar">
                <ul class="widget widget-menu unstyled">
                    <li class="active"><a href="{{ URL::to('/') }}"><i class="menu-icon icon-dashboard"></i>Dashboard</a></li>
                    <li><a href="{{ URL::to('/newsfeed') }}"><i class="menu-icon icon-bullhorn"></i>News Feed </a></li>
