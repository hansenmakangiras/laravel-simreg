    ...
    SITE TITLE
    =========================== -->
    <title>:: PMK LP3I MAKASSAR 2014 ::</title><!-- This is what you see on your browser tab-->

    <!-- ===========================
    FAVICONS
    =========================== -->
   <link rel="icon" href="site/img/favicon.png">
       <link rel="apple-touch-icon" sizes="144x144" href="site/img/apple-touch-icon-ipad-retina.png" />
       <link rel="apple-touch-icon" sizes="114x114" href="site/img/apple-touch-icon-iphone-retina.png" />
       <link rel="apple-touch-icon" sizes="72x72" href="site/img/apple-touch-icon-ipad.png" />
       <link rel="apple-touch-icon" sizes="57x57" href="site/img/apple-touch-icon-iphone.png" />
    ...
    ICONS:
    =========================== -->
    {{HTML::style('site/css/simple-line-icons.css')}}
    <!-- ===========================
    GOOGLE FONTS
    =========================== -->
    {{--{{HTML::style('http://fonts.googleapis.com/css?family=Antic|Raleway:300')}}--}}
